...
const wsBaseUrl = import.meta.env.VITE_BASE_URL;
...
export const useWebSocketService = (
  ...
  const fullUrl = wsBaseUrl + webSocketUrl;
  ...
  const connect = useCallback(() => {
    ...
    const client = new Client({
      ...
      onConnect: () => {
        ...
        console.log(`Connected at ${fullUrl}`);
        onConnectCallback();
      },
      onStompError: error => {
  ...
  }, [state.client, fullUrl, onConnectCallback, onErrorCallback]);
